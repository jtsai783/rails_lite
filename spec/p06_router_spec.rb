...
describe Phase6::Route do
  ...
  describe "#matches?" do
    it "matches simple regular expression", :test1 => true do
    ...
    it "matches regular expression with capture", :test2 => true do
    ...
    it "correctly doesn't matche regular expression with capture", test3: true do
  ...
  describe "#run" do
    ...
    it "instantiates controller and invokes action", test4: true do
